...
class PetServiceImplTest {
    ...
    void createPet_ShouldSavePet() {
        Pet pet = new Pet(1, "Buddy","P21KA23", "Dog", "Golden Retriever", 3);
    ...
    void getAllPets_ShouldReturnListOfPets() {
        ...
        pets.add(new Pet(1, "Buddy","P21KA23", "Dog", "Golden Retriever", 3));
    ...
    void updatePet_ShouldCallRepositoryUpdate() {
        Pet petDetails = new Pet(1, "Buddy","P21KA23", "Dog", "Golden Retriever", 4);
